...
class AdminOrdersController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->col[] = ["label" => "User", "name" => "user_id", "join" => "cms_users,email"];
        ...
        $this->form = [];
        $this->form[] = ['label' => 'User', 'name' => 'user_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'cms_users,email'];
        $this->form[] = ['label' => 'Status', 'name' => 'status', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'dataenum' => '0|Preparing;2|Confirmed;0|Cancelled'];
        ...
        */
        ...
        $this->sub_module[] = ['label' => 'Books', 'path' => 'orders_books', 'foreign_key' => 'order_id', 'parent_columns' => 'id,total,created_at', 'button_color' => 'primary', 'button_icon' => 'fa fa-bars'];
    ...
    */
    public function hook_query_index(&$query)
    {
        //Your code here
        if (\crocodicstudio\crudbooster\helpers\CRUDBooster::me()->id_cms_privileges != User::ADMIN_PRIVILAGE_ID) {
            $query->join("orders_books", 'orders_books.order_id', 'orders.id')
                ->join('books', 'books.id', 'orders_books.book_id')
                ->where('books.user_id', \crocodicstudio\crudbooster\helpers\CRUDBooster::myId());
        }
    }
